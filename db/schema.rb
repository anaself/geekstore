...
ActiveRecord::Schema.define(version: 20160321205604) do
  ...
  create_table "baskets_products", force: :cascade do |t|
    t.integer "basket_id"
    t.integer "product_id"
    t.integer "quantity"
  end

  add_index "baskets_products", ["basket_id", "product_id"], name: "index_baskets_products_on_basket_id_and_product_id", using: :btree
